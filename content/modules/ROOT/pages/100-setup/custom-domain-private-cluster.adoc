...
----
+
NOTE: Your ongoing work that access the cluster needs to be routed through the jump host.
...
Just run the following command, and it should pick up the proper ssh keys and start sshuttle.
+
[source,bash,subs="+macros,+attributes",role=execute]
----
...
----
+
NOTE: To use your laptop's web browser to see the OpenShift console, you'll need to setup sshuttle on your laptop, too.
+
...
----
+
. Run sshuttle on the your laptop
+
