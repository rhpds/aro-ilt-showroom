...
echo "KEYVAULT_RESOURCE_GROUP=$KEYVAULT_RESOURCE_GROUP" >> ~/.bashrc
echo "KEYVAULT_LOCATION=$KEYVAULT_LOCATION" >> ~/.bashrc
echo "KEYVAULT_NAME=$KEYVAULT_NAME" >> ~/.bashrc
echo "AZ_TENANT_ID=$AZ_TENANT_ID" >> ~/.bashrc
----
...
echo "SERVICE_PRINCIPAL_CLIENT_SECRET=$SERVICE_PRINCIPAL_CLIENT_SECRET" >> ~/.bashrc
echo "SERVICE_PRINCIPAL_CLIENT_ID=$SERVICE_PRINCIPAL_CLIENT_ID" >> ~/.bashrc
----
